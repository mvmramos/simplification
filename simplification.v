...
- simpl. 
  ...
  clear H4.
  + subst.
    apply H2 with (left:= left).
    * exact H3.
    * exact H5.
  + subst.
    apply H2 with (left:= b).
  ...
  + split. 
    ...
    * {
      ...
      - intros H1'.
        ...
        unfold has_one_empty_rule in H2'.
        split.
        + destruct H2' as [H2' _].
          simpl in H2'.
          simpl. 
          apply g_acc_g_use_preserves_empty_rule in H2'.
          simpl in H2'.
          exact H2'.
        + destruct H2' as [_ H2'].
          intros left right H3 H4.
          apply g_acc_g_use_preserves_rules in H4.
          simpl in H3.
          specialize (H2' left right H3 H4).
          exact H2'.
      - split.
        + intros H1'.
          unfold has_no_empty_rules.
